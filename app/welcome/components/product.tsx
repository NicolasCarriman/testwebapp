...
function Product() {
    ...
    return (
        <div className='flex flex-col items-start ml-24 gap-8 justify-start pt-16 pb-4 h-[100dvh]'>
            ...
            <Link to={authUrl} className='p-4 bg-gray-800 rounded px-8 font-semibold text-gray-200 hover:bg-black transition-all duration-250 ease-in-out'>Start now</Link>
        </div>
    )
}
